...
//	private List property;// = new List();
	...
	if (e.getSource() == start2 || e.getSource() == start3 || e.getSource() == start4 ){
			...
			if(e.getSource() == start2){
				...
				panel.setLayout(new FlowLayout(1,10,20));
				
				//Dice
				 JLabel jl1 = new JLabel("Die 1");
				 panel.add(jl1);
				 JTextField firstDie = new JTextField( 10 );
				 panel.add( firstDie );
				...
				final JButton jb1 = new JButton("DRAW CARDS");
				jb1.setActionCommand("DRAW CARDS");
				jb1.setEnabled(true);
				...
				jb1.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						ImageIcon icon = new ImageIcon("D:\\APP\\Testing\\src\\c1.png");
						
						JOptionPane.showMessageDialog(null, null, "Card States", 
							    JOptionPane.PLAIN_MESSAGE, icon);
						
					        //JOptionPane.showMessageDialog((Component) e.getSource(), "D:\\APP\\Testing\\src");
				      }
				...
				JLabel label = new JLabel("Vijay Patil");
				panel.add(label);
